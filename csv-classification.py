...
# ID of  student: 208564765
# First and Last Names of student: Guy Beckenstein
...
from sklearn.naive_bayes import GaussianNB # Useless
from sklearn.neighbors import KNeighborsClassifier # Added by me
from sklearn.model_selection import train_test_split, GridSearchCV # Added by me
from sklearn.decomposition import PCA # Added by me
from sklearn.tree import DecisionTreeClassifier # Added by me
    ...
    *** Mandatory structure ***
    ...
    def fit(self, dataset_df):
        ...
        *** This method will be called exactly once during evaluation. See the main section for details ***
        ...
        numerical_columns = ['Height', 'Weight', 'Season', 'Transportation expense', 'Reason', 'Service time', 'Day', 'Residence Distance'] # There are more - what else?
...
def train_model(processed_X, y):
    ...
    # model = GridSearchCV(estimator=KNeighborsClassifier(), param_grid={'n_neighbors': range(1, 11, 2), 'weights': ['distance', 'uniform']}, scoring='average_precision')
